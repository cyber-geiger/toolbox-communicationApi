...
import 'package:test/test.dart';
  ...
  Future<void> OwnerEnforcerTests(final StorageController controller) async {
    test('Owner get Node', () async {
      OwnerEnforcerWrapper ownerEnforcerWrapper = OwnerEnforcerWrapper(
          controller, 'testOwner');
    ...
    test('Owner get Node visibility', () async {
      OwnerEnforcerWrapper ownerEnforcerWrapper = OwnerEnforcerWrapper(
          controller, 'testOwner');
      OwnerEnforcerWrapper ownerEnforcerWrapper2 = OwnerEnforcerWrapper(
          controller, 'testOwner2');
    ...
    test('get Value', () async{
      OwnerEnforcerWrapper ownerEnforcerWrapper = OwnerEnforcerWrapper(
          controller, 'testOwner');
      await ownerEnforcerWrapper.addValue(":testNode1", NodeValueImpl("key1", "value1"));
      NodeValue? value = await ownerEnforcerWrapper.getValue(':testNode1', 'key1');
    ...
    test('update Value', () async{
      OwnerEnforcerWrapper ownerEnforcerWrapper = OwnerEnforcerWrapper(
          controller, 'testOwner');
      await ownerEnforcerWrapper.updateValue(':testNode1', NodeValueImpl("key1", "value2"));
      NodeValue? value = await ownerEnforcerWrapper.getValue(':testNode1', 'key1');
