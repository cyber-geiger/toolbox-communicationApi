...
class SecuredMessage extends Message {
  ...
  SecuredMessage(
      String sourceId, String? targetId, MessageType type, GeigerUrl? action,
      [List<int>? payload, String? requestId])
      : super(sourceId, targetId, type, action, payload, requestId);
  ...
  static Future<SecuredMessage> fromByteArray(ByteStream in_, int? uid) async {
