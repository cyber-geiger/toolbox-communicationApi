...
public class TestApiCallSequences {
  ...
  public void testRegisterPlugin() throws Exception, DeclarationMismatchException {
    ...
    GeigerUrl testUrl = new GeigerUrl("geiger://" + CommunicationApi.MASTER + "/test");
    PluginInformation payload = new PluginInformation("./plugin1", 5555,
        new CommunicationSecret());
    Message request = new Message(CommunicationApi.MASTER, CommunicationApi.MASTER, MessageType.REGISTER_PLUGIN,
  ...
  public void testDeregisterPlugin() throws Exception, DeclarationMismatchException {
    CommunicationApi localMaster = CommunicationApiFactory.getLocalApi("", CommunicationApi.MASTER,
        Declaration.DO_NOT_SHARE_DATA);
    GeigerUrl testUrl = new GeigerUrl("geiger://" + CommunicationApi.MASTER + "/test");
    Message request = new Message(CommunicationApi.MASTER, CommunicationApi.MASTER, MessageType.DEREGISTER_PLUGIN,
        testUrl);
    Message reply = CommunicationHelper.  sendAndWait(localMaster, request,
        (Message msg) -> msg.getType() == MessageType.COMAPI_SUCCESS
  ...
  public void testActivatePlugin() throws Exception, DeclarationMismatchException {
    ...
    Message requestActivate = new Message(CommunicationApi.MASTER, CommunicationApi.MASTER,
  ...
  public void testDeactivatePlugin() throws Exception, DeclarationMismatchException {
    ...
    // deactivate Plugin
    Message requestDeactivate = new Message(CommunicationApi.MASTER, CommunicationApi.MASTER,
  ...
  public void testGetStorage() throws DeclarationMismatchException, StorageException {
    ...
    // check plugin
    CommunicationApi pluginApi = CommunicationApiFactory.getLocalApi("./plugin1", "plugin1",
        Declaration.DO_NOT_SHARE_DATA);
  ...
  public void testRegisterMenu() throws Exception, DeclarationMismatchException {
    ...
    Message request = new Message(CommunicationApi.MASTER, CommunicationApi.MASTER, MessageType.REGISTER_MENU,
        testUrl, payload.toByteArray());
    Message reply = CommunicationHelper.sendAndWait(localMaster, request,
        (Message msg) -> msg.getType() == MessageType.COMAPI_SUCCESS
    );
  ...
  public void testDeregisterMenu() throws Exception, DeclarationMismatchException {
    ...
    Message request2 = new Message(CommunicationApi.MASTER, CommunicationApi.MASTER, MessageType.DEREGISTER_MENU,
  ...
  public void testEnableMenu() throws Exception, DeclarationMismatchException {
    ...
    // enable the menuItem
    Message request2 = new Message(CommunicationApi.MASTER, CommunicationApi.MASTER, MessageType.ENABLE_MENU,
        testUrl, payload.getMenu().getBytes(StandardCharsets.UTF_8));
    Message reply2 = CommunicationHelper.sendAndWait(localMaster, request2,
        (Message msg) -> msg.getType() == MessageType.COMAPI_SUCCESS);
  ...
  public void testDisableMenu() throws Exception, DeclarationMismatchException {
    ...
    // enable the menuItem
    Message request2 = new Message(CommunicationApi.MASTER, CommunicationApi.MASTER, MessageType.DISABLE_MENU,
        testUrl, payload.getMenu().getBytes(StandardCharsets.UTF_8));
    Message reply2 = CommunicationHelper.sendAndWait(localMaster, request2,
        (Message msg) -> msg.getType() == MessageType.COMAPI_SUCCESS);
  ...
  public void testPing() throws Exception, DeclarationMismatchException {
    CommunicationApi localMaster = CommunicationApiFactory.getLocalApi("", CommunicationApi.MASTER,
        Declaration.DO_NOT_SHARE_DATA);
    GeigerUrl testUrl = new GeigerUrl("geiger://" + CommunicationApi.MASTER + "/test");
    Message request = new Message(CommunicationApi.MASTER, CommunicationApi.MASTER, MessageType.PING, testUrl,
