...
public class TestCommunicationSecret {
  ...
  public void testConstructorGetterSetter() {
    ...
    for (int i = 0; i < 20; ++i) {
      byte[] sec = GeigerCommunicator.intToByteArray(Random.nextInt(Integer.MAX_VALUE));
    ...
    for (int i = 0; i < 20; ++i) {
      ...
      byte[] newSecretValue = GeigerCommunicator.intToByteArray(Random.nextInt(Integer.MAX_VALUE));
