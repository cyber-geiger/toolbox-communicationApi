...
public class DemoPluginStageProvider {
  ...
  public DemoPluginStageProvider(StorageController controller) throws StorageException {
    ...
    this.deviceGeigerPlugin = ":Devices:" + localDevice + ":gi7448fc-0795-44a9-8ec6-gicba9520c20:data";
    this.userGeigerPlugin = ":Users:" + localUser + ":gi7448fc-0795-44a9-8ec6-gicba9520c20:data";
    initNodes();
  }
  ...
  private Node[] getInitialNodes() {
    ...
    threatMap.put("80efffaf-98a1-4e0a-8f5e-gr89388352ph", new String[]{"Phishing"});
    threatMap.put("80efffaf-98a1-4e0a-8f5e-gr89388353wa", new String[]{"Web application threats"});
    threatMap.put("80efffaf-98a1-4e0a-8f5e-gr89388354sp", new String[]{"Spam"});
    threatMap.put("80efffaf-98a1-4e0a-8f5e-gr89388355ds", new String[]{"Denial of service"});
    threatMap.put("80efffaf-98a1-4e0a-8f5e-gr89388356db", new String[]{"Data breach"});
    threatMap.put("80efffaf-98a1-4e0a-8f5e-gr89388357it", new String[]{"Insider threats"});
    threatMap.put("80efffaf-98a1-4e0a-8f5e-gr89388358bn", new String[]{"Botnets"});
    threatMap.put("80efffaf-98a1-4e0a-8f5e-gr89388359ph", new String[]{"Physical threats"});
    threatMap.put("80efffaf-98a1-4e0a-8f5e-gr89388360ra", new String[]{"Ransomware", "Malware"});
    threatMap.put("80efffaf-98a1-4e0a-8f5e-gr89388361ee", new String[]{"External environment threats"});
    threatMap.put("80efffaf-98a1-4e0a-8f5e-th89388362wb", new String[]{"Web-based attacks", "Web-based threats"});
    threatMap.put("80efffaf-98a1-4e0a-8f5e-th89388363wa", new String[]{"Web application attacks", "Web-based threats"});
    threatMap.put("80efffaf-98a1-4e0a-8f5e-th89388364ds", new String[]{"DDoS", "Denial of service"});
    threatMap.put("80efffaf-98a1-4e0a-8f5e-th89388365it", new String[]{"Identity theft", "Data breach"});
    threatMap.put("80efffaf-98a1-4e0a-8f5e-th89388366ph", new String[]{"Physical", "Physical threats"});
    threatMap.put("80efffaf-98a1-4e0a-8f5e-th89388367il", new String[]{"Information leakage", "Insider threats"});
    threatMap.put("80efffaf-98a1-4e0a-8f5e-th89388368cj", new String[]{"Cryptojacking", "Malware"});
    threatMap.put("80efffaf-98a1-4e0a-8f5e-th89388369er", new String[]{"Erroneous use", "Insider threats"});
    threatMap.put("80efffaf-98a1-4e0a-8f5e-th89388370tp", new String[]{"Third party", "External environment threats"});
    threatMap.put("80efffaf-98a1-4e0a-8f5e-th89388371sc", new String[]{"Supply chain", "External environment threats"});
    threatMap.put("80efffaf-98a1-4e0a-8f5e-th89388372le", new String[]{"Legal", "External environment threats"});
  ...
  private String getThreatUuid() throws StorageException {
    List<Node> n = controller.search(new SearchCriteria(":Global:threats","name","%"));
        ...
        new NodeImpl(userGeigerPlugin, null,
            ...
            new Node[]{
                ...
                new NodeImpl(userGeigerPlugin + ":recommendations", null,
                    new NodeValue[]{
                        new NodeValueImpl("80efffaf-98a1-4e0a-8f5e-gr89388355ds", ""),
                    }, null
                )
            }
        ),
        new NodeImpl(deviceGeigerPlugin, null,
            ...
            new Node[]{
                new NodeImpl(deviceGeigerPlugin + ":GeigerScoreDevice", null,
                    new NodeValue[]{
                        new NodeValueImpl("threats_score", "")
                    }, null
                ),
