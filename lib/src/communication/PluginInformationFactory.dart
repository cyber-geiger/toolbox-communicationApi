...
class PluginInformationFactory
{
    ...
    static PluginInformation getPluginInformation(String id, String executor, int port, CommunicationSecret secret)
    {
    ...
    static PluginInformation setPluginInformation(String id, PluginInformation info)
    {
