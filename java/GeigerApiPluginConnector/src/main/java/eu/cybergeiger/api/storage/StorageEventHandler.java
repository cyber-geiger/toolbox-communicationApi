...
public class StorageEventHandler implements PluginListener {
  ...
  public StorageEventHandler(CommunicationApi api, StorageController sc) {
  ...
  public void storageEventParser(Message msg) {
    if (CommunicationApi.MASTER.equals(msg.getTargetId())) {
      isMaster = true;
    }
    // parse GeigerUrl
  ...
  private void getNode(Message msg, String identifier, String[] optionalArgs) {
    ...
    try {
      ...
      communicationApi.sendMessage(msg.getSourceId(), new Message(msg.getTargetId(), msg.getSourceId(),
